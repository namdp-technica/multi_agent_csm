...
class StoryFlowAgent(BaseAgent):
    ...
    async def _run_async_impl(
        ...
        """Chạy tác nhân story_generator bất đồng bộ.
            Duyệt qua các event được sinh ra và log nội dung của mỗi event dưới dạng JSON.
            yield event: Trả lại event cho hệ thống orchestration xử lý."""
        ...
        """Kiểm tra xem current_story có tồn tại trong session state không. Nếu không, dừng workflow."""
        ...
        """Chạy tác nhân vòng lặp CriticReviserLoop – nơi story được phê bình và chỉnh sửa nhiều lần.
            Log và yield các event như trên."""
        ...
        async for event in self.loop_agent.run_async(ctx):
            ...
            yield event
        """Chạy tác nhân hậu xử lý (chẳng hạn kiểm tra ngữ pháp, tone).

Log và yield các event."""
